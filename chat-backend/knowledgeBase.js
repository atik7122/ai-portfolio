...
He currently works at Robi Axiata Limited, building large-scale machine learning and AI systems.
`,
...
`,
  ...
  programming languages: Zubair programs primarily in Python and also uses C and C++, JavaScript, TypeScript, and advanced SQL.
...
`,
    ...
    research: `
    Zubair has published peer-reviewed research including:
    - Transformer-Based Sentiment Analysis for Software Engineering (ICSOFT 2023)
    - Nurse Care Activity Recognition (UbiComp/ISWC 2021 Workshop)
    `,
    ...
    contact: `
        You can get in touch with Zubair Rahman Tusar for collaboration, projects, or professional opportunities.
           ...
           or Phone: +8801863835789  
            or Location: Banasree, Dhaka, Bangladesh 
           or You can contact with him from the contact form which is exist in contact section in his portfolio
